...
![端口号](/assets/images/2026-02-15/1-1.png)
...
![命令窗口1](/assets/images/2026-02-15/1-2.png)

![命令窗口2](/assets/images/2026-02-15/1-3.png)

![命令窗口3](/assets/images/2026-02-15/1-4.png)
...
![目录](/assets/images/2026-02-15/1-5.png)

按键盘快捷键`win+r`打开运行窗口

输入`sysdm.cpl`打开系统属性窗口，随后依次点击：高级→环境变量→找到“系统变量”里面的`PATH`，选中并点击“编辑”→点击“新建”，将复制的目录粘贴，然后点击“确定”即可

![环境变量1](/assets/images/2026-02-15/1-6.png)

![环境变量2](/assets/images/2026-02-15/1-7.png)

![环境变量3](/assets/images/2026-02-15/1-8.png)

![环境变量4](/assets/images/2026-02-15/1-9.png)
...
![使用效果](/assets/images/2026-02-15/1-10.png)
